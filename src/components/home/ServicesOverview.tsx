      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-12">
          ...
          >
            <Link 
              href="/services" 
              className="inline-flex items-center space-x-2 text-black/60 hover:text-black transition-colors group"
            >
          ...
          {services.map((service, i) => (
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-semibold text-black mb-6 tracking-tight">{service.title}</h3>
                <p className="text-lg text-black/60 leading-relaxed mb-10 max-w-sm">
                  {service.description}
                </p>
                <Link 
                  href={service.href} 
                  className="inline-flex items-center text-sm font-bold text-black uppercase tracking-widest hover:opacity-70 transition-opacity"
                >
                  Explore Service
              ...
              {/* Background Glow */}
              <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-black/[0.02] rounded-full blur-3xl group-hover:bg-black/[0.05] transition-colors duration-500" />
            </div>
          ))}
        </div>
      </div>
